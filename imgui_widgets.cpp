...
void    ImGui::TableUpdateLayout(ImGuiTable* table)
{
    ...
    for (int order_n = 0; order_n < table->ColumnsCount; order_n++)
    {
        ...
        column->NavLayerCurrent = (table->FreezeRowsRequest > 0 || column_n < table->FreezeColumnsRequest) ? ImGuiNavLayer_Menu : ImGuiNavLayer_Main;
...
void    ImGui::TableEndRow(ImGuiTable* table)
{
    ...
    if (unfreeze_rows_request)
        ...
        {
            ImGuiTableColumn* column = &table->Columns[column_n];
            column->NavLayerCurrent = (column_n < table->FreezeColumnsRequest) ? ImGuiNavLayer_Menu : ImGuiNavLayer_Main;
        }
